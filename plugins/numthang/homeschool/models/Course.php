...
class Course extends Model
{
    ...
    protected $fillable = ['user_id', 'hs_name', 'name', 'student_name', 'birth_date', 'school_exp', 'development', 'part1_label', 'part1', 'part2_label', 'part2', 'part3_label', 'part3', 'part4_label', 'part4', 'other', 'cover', 'gender'];
