...
class Course extends Model
{
    ...
    protected $fillable = ['user_id', 'hs_name', 'name', 'student_name', 'birth_date', 'school_exp', 'development', 'class_reason', 'purpose', 'format', 'schedule', 'curriculum', 'activity', 'learning', 'evaluate', 'other', 'cover'];//กำหนด field ให้เป็น fillable
